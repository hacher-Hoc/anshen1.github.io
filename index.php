...
<head>
    <title>睡到八点半</title>
    <meta itemprop="name" content="睡到八点半" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">睡到八点半</div><br />
                ...
                <div id="btn_group" style="display: block;">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="mode">
                            <li><a class="dropdown-item" onclick="changeMode(MODE_NORMAL)">睡觉模式</a></li>
                            <li><a class="dropdown-item" onclick="changeMode(MODE_ENDLESS)">泡面模式</a></li>
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="睡到八点半">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
